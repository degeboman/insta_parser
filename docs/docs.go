    ...
    "definitions": {
        ...
        "handlers.ClipMoneyParsingUrlResponse": {
            ...
            "properties": {
                "data": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/models.ResultRowUrl"
                        }
                    ]
                },
                "message": {
        ...
        "models.ResultRowUrl": {
            ...
            "properties": {
                ...
                "er": {
                    "description": "ER (likes+shares+comments)/views*100",
                    "type": "string"
                },
                "erID": {
                ...
                "views": {
                    "description": "Охват факт",
                    "type": "integer",
                    "format": "int64"
                },
                "virality": {
                    "description": "Виральность (shared/views)*100",
                    "type": "string"
                }
            }
        }
